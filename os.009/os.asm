...
;       Scan Codes Returned
;
;       Set 1                           Base            Shift           KEYDOWN         KEYUP           CHAR
...
;               E0 2A E0 37/E0 B7 E0 AA PrntScrn                       *7700/7700      *F700/F700
...
;                                       Num-Lock Keypad-7               4737/4737       C737/C737       4737/4737
;                                       Left-Shift Keypad-7             4737/4737       C737/C737       4737/4737
;                                       Right-Shift Keypad-7            4737/4737       C737/C737       4737/4737
;               47/2A                   Num-Lock Left-Shift Keypad-7    4700/4700       C700/C700
;               47/36                   Num-Lock Right-Shift Keypad-7   4700/4700       C700/C700
;               E0 47/E0 C7             Home                           *6700/6700      *E700/E700
;               E0 47/E0 36             Right-Shift Home               *6700/6700      *E700/E700
;               E0 2A E0 47/E0 AA       Num-Lock Home                  *6700/6700      *E700/E700
;       48/C8                           Keypad-8                        4800/4800       C800/C800
;                                       Num-Lock Keypad-8               4838/4838       C838/C838       4838/4838
;                                       Left-Shift Keypad-8             4838/4838       C838/C838       4838/4838
;                                       Right-Shift Keypad-8            4838/4838       C838/C838       4838/4838
;               48/2A                   Num-Lock Left-Shift Keypad-8    4800/4800       C800/C800
;               48/36                   Num-Lock Right-Shift Keypad-8   4800/4800       C800/C800
;               E0 48/E0 C8             Up-Arrow                       *6800/6800      *E800/E800
;               E0 48/E0 36             Right-Shift Up-Arrow           *6800/6800      *E800/E800
;               E0 2A E0 48/E0 AA       Num-Lock Up-Arrow              *6800/6800      *E800/E800
;       49/C9                           Keypad-9                        4900/4900       C900/C900
;                                       Num-Lock Keypad-9               4939/4939       C939/C939       4939/4939
;                                       Left-Shift Keypad-9             4939/4939       C939/C939       4939/4939
;                                       Right-Shift Keypad-9            4939/4939       C939/C939       4939/4939
;               49/2A                   Num-Lock Left-Shift Keypad-9    4900/4900       C900/C900
;               49/36                   Num-Lock Right-Shift Keypad-9   4900/4900       C900/C900
;               E0 49/E0 C9             Page-Up                        *6900/6900      *E900/E900
;               E0 49/E0 36             Right-Shift Page-Up            *6900/6900      *E900/E900
;               E0 2A E0 49/E0 AA       Num-Lock Page-Up               *6900/6900      *E900/E900
;       4A/CA                           Keypad-Minus                    4A2D/4A2D       CA2D/CA2D       4A2D/4A2D
;       4B/CB                           Keypad-4
;                                       Num-Lock Keypad-4
;                                       Left-Shift Keypad-4
;                                       Right-Shift Keypad-4
;                                       Num-Lock Left-Shift Keypad-4
;                                       Num-Lock Right-Shift Keypad-4

;               E0 4B/E0 CB             Left-Arrow
;                                       Left-Shift Left-Arrow
;                                       Right-Shift Left-Arrow
;               E0 2A E0 49/E0 C9       Num-Lock Left-Arrow
;                                       Num-Lock Left-Shift Left-Arrow
;                                       Num-Lock Right-Shift Left-Arrow
...
;       4D/CD                           Keypad-6
;                                       Num-Lock Keypad-6
;               E0 4D/E0 CD             Right-Arrow
;               E0 2A E0 4D/E0 CD       Num-Lock Right-Arrow
...
;               E0 4F/E0 CF             End
;               E0 2A E0 4F/E0 CF       Num-Lock End
;                                       Left-Shift End

;       50/D0                           Keypad-2
;               E0 50/E0 D0             Down-Arrow
;               E0 2A E0 50/E0 D0       Num-Lock Down-Arrow
;                                       Left-Shift Down-Arrow

;       51/D1                           Keypad-3                        5100/5100
;               E0 51/E0 D1             Page-Down
;               E0 2A E0 51/E0 AA       Num-Lock Page-Down
;                                       Left-Shift Page-Down

;       52/D2                           Keypad-0
;                                       Num-Lock Keypad-0
;                                       Left-Shift Keypad-0
;                                       Right-Shift Keypad-0
;               52/2A                   Num-Lock Left-Shift Keypad-0
;               52/36                   Num-Lock Right-Shift Keypad-0
;               E0 52/E0 D2             Insert
;               E0 52/E0 36             Right-Shift Insert
;               E0 2A E0 52/E0 AA       Num-Lock Insert

;       53/D3                           Keypad-Period                   537F/537F       D37F/D37F       537F/537F
;                                       Num-Lock Keypad-Period          532E/532E       D32E/D32E       532E/532E
;               53/2A                   Num-Lock Left-Shift Keypad-Period
;               53/36                   Num-Lock Right-Shift Keypad-Period
;
;               E0 53/E0 D3             Delete                         *737F/737F      *F37F/F37F      *737F/737F
;               E0 53/E0 36             Right-Shift Delete             *737F/737F      *F37F/F37F      *737F/737F
;               E0 2A E0 53/E0 AA       Num-Lock Delete                *737F/737F      *F37F/F37F      *737F/737F
...
;
;       Custom Key Make/Break Codes
;
;       5C/DC                           Keyboard-Enter
;       5D/DD                           Right-Ctrl
;       67/E7                           Home
;       68/E8                           Up-Arrow
;       69/E9                           Page-Up
...
;-----------------------------------------------------------------------------------------------------------------------
                        ...
                        mov     al,EKEYFTIMEOUT                                 ;keyboard chip timeout indicator
...
;
;       Translate scan code to extended scan codes.
;
irq1.usescan3           movzx   eax,byte [wbConsoleScan3]                       ;for (e0 2a) use scan code 3
                        jmp     short irq1.translate
irq1.usescan1           movzx   eax,byte [wbConsoleScan1]                       ;for (e0) use scan code 1
irq1.translate          mov     al,[cs:tscan2ext+eax]                           ;translate to alternate
...
;
                        ...
                        jmp     irq1.checkcaps                                  ;display scan code
irq1.shifted            mov     al,[cs:tscan2shift+eax]                         ;look from shift
;
;       If ASCII letter, flip case if caps-lock is on.
;
irq1.checkcaps          test    byte [wbConsoleLock],EKEYFLOCKCAPS              ;caps lock on?
...
;
                        ...
                        mov     al,[wbConsoleScan]                              ;scan code
...
irq1.locktest           mov     ah,EKEYFLOCKCAPS                                ;caps-lock flag
                        ...
                        cmp     al,EKEYBINSERTDOWN                              ;insert up code?
                        jne     irq1.putmessage                                 ;no, branch
...
;
irq1.putmessage         mov     al,[wbConsoleChar]                              ;ASCII char
...
irq1.makecode           and     eax,0FFFFh                                      ;clear high-order word
                        ...
                        jz      irq1.putshift                                   ;no, skip ahead
...
tscan2ext               db      000h,000h,000h,000h,000h,000h,000h,000h         ;00-07
                        ...
                        db      000h,000h,000h,000h,000h,000h,000h,067h         ;40-47  47->67
                        db      068h,069h,000h,06Bh,000h,06Dh,000h,06Fh         ;48-4f  48->68,49->69,4b->6b,4d->6d,4f->6f
                        ...
                        db      000h,000h,000h,000h,000h,000h,000h,0E7h         ;c0-c7  c7->e7
                        db      0E8h,0E9h,000h,0EBh,000h,0EDh,000h,0EFh         ;c8-cf  c8->e8,c9->e9,cb->eb,cd->ed,cf->ef
...
tsvc                    tsvce   CompareMemory                                   ;compare memory
                        ...
                        tsvce   GetConsoleKeyDown                               ;get key-down event
                        tsvce   GetConsoleKeyStroke                             ;get keyboard event
...
%endmacro
%macro                  getConsoleChar 0
                        mov     al,eGetConsoleChar                              ;function code
                        int     _svc                                            ;invoke OS service
%endmacro
%macro                  getConsoleKeyDown 0
                        mov     al,eGetConsoleKeyDown                           ;function code
                        int     _svc                                            ;invoke OS service
%endmacro
%macro                  getConsoleKeyStroke 0
                        mov     al,eGetConsoleKeyStroke                         ;function code
                        int     _svc                                            ;invoke OS service
%endmacro
...
GetConsoleChar          call    GetMessage                                      ;get the next message
                        ...
                        jz      GetConsoleChar.10                               ;no, continue
                        mov     edx,eax                                         ;save key codes
                        and     edx,0FFFF0000h                                  ;mask for message type
                        cmp     edx,EMSGKEYCHAR                                 ;key-char message?
                        jne     GetConsoleChar                                  ;no, continue
                        and     eax,0000ffffh                                   ;mask for key codes
                        ret                                                     ;return

GetConsoleKeyDown.10    call    Yield
GetConsoleKeyDown       call    GetMessage
                        test    eax,eax
                        jz      GetConsoleKeyDown.10
                        mov     edx,eax                                         ;save key codes
                        and     edx,0FFFF0000h                                  ;mask for message type
                        cmp     edx,EMSGKEYDOWN                                 ;key-down message?
                        jne     GetConsoleKeyDown
                        and     eax,0000ffffh
                        ret

GetConsoleKeyStroke.10  call    Yield                                           ;pass control or halt
GetConsoleKeyStroke     call    GetMessage                                      ;get the next message
                        test    eax,eax                                         ;do we have a message?
                        jz      GetConsoleKeyStroke.10                          ;no, continue
                        mov     edx,eax                                         ;save key codes
                        and     edx,0FFFF0000h                                  ;mask for message type
                        cmp     edx,EMSGKEYDOWN                                 ;key-down message?
                        je      .20                                             ;yes, branch
                        cmp     edx,EMSGKEYUP                                   ;key-up message?
                        je      .20                                             ;yes, branch
                        cmp     edx,EMSGKEYCHAR                                 ;char message?
                        jne     GetConsoleKeyStroke                             ;no, continue
.20                     ret
...
;
                        mov     al,[wbConsoleScan]
                        mov     ch,ECONOIAROW
                        mov     cl,17
                        call    PutConsoleHexByte
                        mov     al,[wbConsoleChar]
                        mov     ch,ECONOIAROW
                        mov     cl,19
                        call    PutConsoleHexByte
;
...
;
                        ...
                        cmp     al,EASCIITILDE                                  ;printable? (upper-bounds)
                        jbe     .36                                             ;yes, branch
.35                     mov     al,EASCIISPACE                                  ;use space for non-printables
.36                     mov     ch,bh                                           ;OIA row
                        mov     cl,40                                           ;character display column
                        call    SetConsoleChar                                  ;display ASCII character
;
;       Display timeout flag.
;
.40                     mov     al,EKEYFTIMEOUT
                        test    byte [wbConsoleStatus],al
                        jz      .50
                        mov     al,'!'
                        mov     ch,ECONOIAROW
                        mov     cl,79
...
;       Restore and return.
;
.50                     pop     es                                              ;restore non-volatile regs
                        pop     esi                                             ;
                        pop     ecx                                             ;
                        pop     ebx                                             ;
                        ret                                                     ;return
...
ConCode                 call    ConInit                                         ;initialize storage
                        call    ConMain                                         ;initialize panel
.10                     call    ConClearPanel                                   ;clear panel rows
                        call    ConDrawFields                                   ;draw fields
                        call    ConEditField                                    ;edit the active field
                        jmp     .10                                             ;refresh panel
;-----------------------------------------------------------------------------------------------------------------------
;
;       Routine:        ConInit
;
;       Description:    This routine initialize console task storage.
;
;-----------------------------------------------------------------------------------------------------------------------
ConInit                 push    ebx                                             ;save non-volatile regs
                        push    ecx                                             ;
                        push    edi                                             ;
                        push    es                                              ;
;
...
;
                        ...
                        mov     [wdConsoleOffset],eax                           ;save target offset
;
;       Clear the entire field.
;
                        mov     al,EASCIISPACE                                  ;ASCII space
                        mov     ah,[ebx+10]                                     ;attribute
                        cmp     ebx,[wdConsoleField]                            ;active field?
                        jne     .10                                             ;no, branch
                        or      ah,08h                                          ;active field intensity
.10                     mov     edi,[wdConsoleOffset]                           ;target offset
...
;
                        ...
                        jz      .30                                             ;no, exit
                        mov     edi,[wdConsoleOffset]                           ;target offset
.20                     lodsb                                                   ;field character
                        test    al,al                                           ;end of value?
                        jz      .30                                             ;yes, branch
                        stosw                                                   ;store character with attribute
                        jmp     .20                                             ;next character
;
;       Restore and return.
;
...
;-----------------------------------------------------------------------------------------------------------------------
;
;       Routine:        ConEditField
;
;       Description:    This routine handles console input for a panel. There does not need to be an active field.
;                       If there is an active field, simple edits are applied to the field buffer and screen. The
;                       cursor position is updated. The routine returns when an attention-indicator key is pressed.
;
;-----------------------------------------------------------------------------------------------------------------------
ConEditField            push    ebx                                             ;save non-volatile regs
                        push    ecx                                             ;
                        push    esi                                             ;
                        push    edi                                             ;
;
;       Skip cursor placement if we have no active field or no buffer.
;
                        mov     ebx,[wdConsoleField]                            ;active field
.10                     test    ebx,ebx                                         ;have active field?
                        jz      .20                                             ;no, branch
                        cmp     dword [ebx],0                                   ;have buffer?
                        je      .20                                             ;no, branch
;
;       Place the cursor at the current index into the field.
;
                        mov     al,[ebx+4]                                      ;field row
                        mov     [wbConsoleRow],al
                        mov     al,[ebx+5]                                      ;field column
                        add     al,[ebx+7]                                      ;add index
                        mov     [wbConsoleColumn],al
                        placeCursor                                             ;position the cursor
;
;       Get a keypress. Exit if attention identifier.
;
.20                     getConsoleKeyDown                                       ;AH = scan; AL = ASCII
...
;
                        ...
                        jne     .40
.30                     cmp     byte [ebx+7],0                                  ;index is zero?
                        je      .20                                             ;yes, get another character
                        dec     byte [ebx+7]                                    ;decrement index
                        jmp     .10                                             ;place cursor and get next char
;
;       Handle right or down arrow
;
.40                     cmp     ah,EKEYBRIGHTARROWDOWN
                        je      .50
                        cmp     ah,EKEYBDOWNARROWDOWN
                        jne     .70
.50                     movzx   edx,byte [ebx+7]                                ;field index
                        mov     ecx,[ebx]                                       ;field buffer?
                        jecxz   .60                                             ;no, branch
                        cmp     byte [ecx+edx],0                                ;at end of input?
                        je      .60                                             ;yes, branch
                        inc     dl                                              ;increment index
                        cmp     dl,byte [ebx+6]                                 ;compare to size
                        jnb     .60                                             ;branch if at limit
                        mov     [ebx+7],dl                                      ;update index
.60                     jmp     .10                                             ;place cursor and get next char
;
;       Handle backspace
;
.70                     cmp     al,EASCIIBACKSPACE
                        jne     .90
                        cmp     byte [ebx+7],0                                  ;index is zero?
                        je      .20                                             ;yes, continue
                        dec     byte [ebx+7]                                    ;decrement index
                        mov     edi,[ebx]                                       ;field buffer
                        movzx   edx,byte [ebx+7]
                        add     edi,edx                                         ;add index
                        mov     esi,edi                                         ;current position
                        inc     esi                                             ;source offset
.80                     lodsb                                                   ;field character
                        stosb                                                   ;promote
                        test    al,al                                           ;end of field data?
                        jnz     .80                                             ;no, continue
                        call    ConDrawField                                    ;redraw field
                        jmp     .10                                             ;place cursur and get next char
;
;       Handle printables.
;
.90                     cmp     al,EASCIISPACE
                        jb      .20
                        cmp     al,EASCIITILDE
                        ja      .20
                        mov     edi,[ebx]
...
;       Call panel handler
;
.100                    mov     ecx,[wdConsoleHandler]
                        jecxz   .110
                        call    ecx
;
;       Restore and return.
;
.110                    pop     edi                                             ;restore non-volatile regs
                        pop     esi                                             ;
                        pop     ecx                                             ;
                        pop     ebx                                             ;
                        ret                                                     ;return
...
;
;-----------------------------------------------------------------------------------------------------------------------
ConMain                 mov     eax,[cdHandlerMain]                             ;main panel handler
                        mov     [wdConsoleHandler],eax                          ;set panel handler addr
                        mov     eax,czPnlMain01                                 ;initial console panel
                        mov     [wdConsolePanel],eax                            ;set panel template addr
                        xor     eax,eax                                         ;zero register
                        mov     [wdConsoleField],eax                            ;zero active field
                        ret
;-----------------------------------------------------------------------------------------------------------------------
;
;       Routine:        ConMem
