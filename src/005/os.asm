...
;       Project:        005
;
;       Description:    In this sample, a keyboard interrupt handler is added. Keyboard scan codes and translated
;                       character codes are displayed on an operator information area (OIA) row.
;
;       Revised:        4 July 2020
;
...
;       Draw prompt field.
;
                        mov     ebx,czPromptField                               ;prompt field structure
                        call    ConDrawField                                    ;draw the prompt field
;
;       Draw input field.
;
                        mov     ebx,czInputField                                ;input field structure
                        call    ConDrawField                                    ;draw the input field
;
;       Place the cursor at the current field index.
;
                        mov     ebx,czInputField                                ;current field
...
czTitle                 db      "Custom Operating System 1.0",13,10             ;title and version
                        db      "Copyright (C) 2010-2020 David J. Walling",13,10,0
