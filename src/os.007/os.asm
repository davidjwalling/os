...
;
.70                     cmp     ah,EKEYBBACKSPACE                               ;backspace?
                        jne     .90                                             ;no, branch
...
;
.100                    call    ConDrawField                                    ;redraw field
...
;       Clear field.
;
.10                     mov     ebx,czPanelHomeInput                            ;home panel input field
...
;       Restore and return.
;
.20                     pop     ebx                                             ;restore non-volatile regs
                        ret                                                     ;return
;-----------------------------------------------------------------------------------------------------------------------
;
