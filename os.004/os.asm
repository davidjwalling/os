...
;	Project:	os.004
;
;	Description:	In this sample program, the loader is expanded to validate the CPU type and to place the CPU
;			into protected mode.
;
...
.20			push	cx						;save remaining tries
			...
			jmp	short .50					;branch to error routine
;
...
section			unused							;unused disk space
			times	1474560-09400h db 0F6h				;fill to end of disk image
%endif
