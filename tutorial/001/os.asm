...
;       Project:        001
;
;       Description:    This program defines a boot sector that displays a message and waits for a key to be pressed to
;                       restart the system. Real mode BIOS interrupts are used to display the message and poll for a
;                       keypress. Using assembly directives, either a simple boot sector or an entire floppy disk image
;                       is generated. The boot sector, os.dat, may be copied onto the the first sector of a diskette to
;                       boot a physical system. The disk image, os.dsk, may be used to configure a virtual machine.
;
;       Revised:        1 Jan 2023
;
...
;                       address operands usually, therefore, indicate reuse.
;
...
;       sets. Equates in this program are defined in the following groupings:
;
